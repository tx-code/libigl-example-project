...
namespace imgui {
    void SelectionWidget::init(igl::opengl::glfw::Viewer* _viewer, ImGuiPlugin* _plugin) {
...
igl::opengl::glfw::imgui::SelectionWidget usage:
  ...
  V,v     Turn off interactive selection
    ...
    void SelectionWidget::circle(const Eigen::Matrix<float, 2, 2>& M, std::vector<Eigen::RowVector2f>& L) {
        L.clear();
        L.reserve(64);
    ...
    void SelectionWidget::rect(const Eigen::Matrix<float, 2, 2>& M, std::vector<Eigen::RowVector2f>& L) {
        L.resize(4);
